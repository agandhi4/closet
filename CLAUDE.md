...
src/
  ...
  file/                FileService abstract (variants, thumbs, versions, deleteVariants) over the local-file/
                       backend (get/store/delete/list only); image-variant.ts names variants,
